...
M.config = function()
	...
	local diff3_map_list = require("core.keymaps.diffview").diff3_keymap_list()
	local help_panel_map_list = require("core.keymaps.diffview").help_panel_keymap_list()
	local option_panel_map_list = require("core.keymaps.diffview").option_panel_keymap_list()
